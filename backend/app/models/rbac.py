...
DEFAULT_SCHOOL_ROLES = [
    ...
    ('HR',                   'HR',                   4, False, False),
    ('RECEPTIONIST',         'Receptionist',         5, False, False),
    ('HOSTEL',               'Hostel Warden',        6, False, False),
    ('TRANSPORT',            'Transport Manager',    7, False, False),
    ('LIBRARIAN',            'Librarian',            8, False, False),
    ('EXAM_CONTROLLER',      'Exam Controller',      9, False, False),
    ('TEACHER',              'Teacher',              10, False, False),
    ('CLASS_TEACHER',        'Class Teacher',        10, False, False),
    ('ASSISTANT_TEACHER',    'Assistant Teacher',    11, False, False),
    ('STUDENT',              'Student',              12, False, False),
    ('PARENT',               'Parent',               13, False, False),
]
