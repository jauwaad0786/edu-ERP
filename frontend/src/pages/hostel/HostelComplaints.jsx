  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: darkMode ? '#0f172a' : '#f8fafc' }}>
      ...
      {resolveModal && selectedComp && (
        <div className="modal-backdrop" role="button" tabIndex={0} aria-label="Close modal" onClick={(e) => e.target === e.currentTarget && setResolveModal(false)} onKeyDown={(e) => e.key === 'Escape' && setResolveModal(false)}>
